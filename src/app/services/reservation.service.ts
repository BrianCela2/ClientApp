...
export class ReservationService {
  ...
  getReservationOfUser(
    ...
    return this.httpClient.get<any>(
      `${this.url}/GetReservationForUser?page=${page}&pageSize=${pageSize}&sortField=${sortField}&sortOrder=${sortOrder}&searchString=${searchString}`
    );
  }
  ...
  updateReservation(
    id: string,
    updateReservationDto: UpdateReservation
  ): Observable<any> {
